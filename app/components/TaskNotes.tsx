...
export default function TaskNotes({ notes, onChange, className = '', darkMode = false }: TaskNotesProps) {
      ...
      {isEditing ? (
        <div className="space-y-2">
          <textarea
            ...
            className="w-full p-2 border border-gray-300 dark:border-slate-600 rounded-md focus:ring-indigo-500 focus:border-indigo-500 h-24 text-sm dark:bg-slate-700 dark:text-white"
          ...
          <div className="flex justify-end gap-2">
            ...
            <button
              onClick={handleSave}
              className="px-2 py-1 text-xs bg-indigo-600 text-white rounded hover:bg-indigo-700 dark:bg-indigo-700 dark:hover:bg-indigo-600"
            >
              Save
            </button>
          </div>
